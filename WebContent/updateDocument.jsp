...
<body>
	...
	<%
		...
		<div class="dark-overlay">
			<h1 class="display-4">Update Document</h1>
			<hr/>
					...
					<div class="col-lg-12 ">
						<div class="card bg-dark">
							<div class="card-body">
								...
								<form action="UpdateDocumentController" method="post">
									<div class="form-group">
										<label for="title">Document Title</label>
										 <input
											...
											placeholder=" Enter Document Title" name="title" id="title" value="<%=document.getTitle()%>">
									</div>

									<div class="form-group">
										<label for="content">Data</label>
										<textarea class="form-control" rows="8" id="content"
											name="content"> <%=document.getContent()%></textarea>
									</div>

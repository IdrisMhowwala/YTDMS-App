				...
				<table class="table mt-1 " id="table">
					<thead class="bg-dark text-white text-center">
						<tr>
							...
							<th scope="col" id="serial-column">Section Name</th>
							<th scope="col" id="serial-column">Section Description</th>
							<th scope="col" id="serial-column">Category Name</th>
							<th scope="col" id="serial-column" colspan="2">Edit</th>
						</tr>
					</thead>
					<tbody >
						...
						<c:forEach var="type" items="${sections}">
							...
							<tr class="table " id="row">
								...
								<td scope="col" style=""><a href="ListDocumentController?sectionId=${type.key.getId()}" ><c:out value="${type.key.getName()}" /></a> </td>

								<td scope="col"><c:out value="${type.key.getDescription()}" /> </td>

								<td scope="col"><c:out value="${type.value}" /> </td>


								<td class="text-center p-2" scope="col">
								<a

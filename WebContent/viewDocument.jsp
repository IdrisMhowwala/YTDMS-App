...
<body>
	...
	<div class="container">
		...
		<div id="main-section bg-light text-muted py-5 ">
			<%
				Document document = (Document) session.getAttribute("document");
			%>
			<h2>
				<span class="text-monospace">Document </span>
			</h2>
			<hr>
			<div class="container">
			
			<h2 class="jumbotron jumbotron-fluid p-3  text-center"><label for="name">
			<span class="text-monospace"><%=document.getTitle()%> </span>
				</label>
				</h2><p></p>
			</div>
			<div class="container">
			<div id="content-Section">
				<p class="text-justify"><%=document.getContent()%> </p>
			</div>

...
<body>
  ...
  <div class="container overflow-auto">
    ...
    <div id="main-section">
            ...
            <div>
           <c:forEach items="${listGroupNames}" var="groupName">
           
           
           <div class="card">
						<div class="card-header text-uppercase">
							<c:out value="${groupName.name}"></c:out>
						</div>
						<div class="card-body text-dark">
							<p>
								<c:out value="${groupName.description}"></c:out>
							</p>
						</div>
						<div class="card-footer">
							 <a class="btn btn-info" href="PermissionController?id=${groupName.id}">Enter</a>
						</div>
					</div>         
